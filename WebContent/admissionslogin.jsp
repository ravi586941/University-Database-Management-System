...
<body>
				...
				<form action="<%=request.getContextPath()%>/UniversityController" method="post">
					...
					<li>
					 ...
					 <div class ="forgot">
						<h3><a href="admissionssignup.jsp">Sign Up</a></h3>
						<input type="submit" name="studentlogin" onclick="myFunction()" value="Login" > <a href="#" class=" icon arrow"></a>                                                                                                                                                                                                                                 </h4>
					</div>
				</form>
			</div>
			<!--//End-login-form-->
