...
<center><input type="submit" value="Delete" name="deleteapplication"/></center>&nbsp;&nbsp;&nbsp;
</form><br/><%}
else{%>

	<center><h3><font color="blue">Selected students were Deleted successfully.</font><br/>
	For security reasons you have been logged out. Please<a href="login.jsp">Login</a>again<br/></h3></center>
